...
func LoadConfig() (config *Config, err error) {
	...
	v.SetDefault("DB_PRIMARY", "postgres://postgres:qwerty@localhost:5432/chatapp?sslmode=disable")
	v.SetDefault("DB_REPL1", "postgres://postgres:qwerty@localhost:5433/chatapp?sslmode=disable")
